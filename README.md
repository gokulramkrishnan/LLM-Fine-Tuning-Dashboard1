...
DETAILS OF THE DESIGN AND FRAMEWORK:
====================================
...
Screen #1 : Dashboard -> Provides overall summary of all available metrics
Screen #2 : Data -> Allows users to upload data
Screen #3 : Models -> Inventory of models
Screen #4 : Fine-tuning -> Tuning and optimizing the model parameters
Screen #5 : Evaluation -> Validaiton the performance of the developed model
Screen #6 : Deploy -> Facilates the deployment of the model and configration parameters
